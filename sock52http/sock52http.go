...
var (
	sockaddr   = flag.String("s", "127.0.0.1:7000", "socks address")
	listenaddr = flag.String("h", ":7001", "http listen address")
	logable = flag.Bool("l", false, "show logs" )
)
...
func main() {
	...
	log.Printf("starting local http server at %v for socks5  %v  ...\n",  *listenaddr, *sockaddr)
